package com.udemyspringappdemo.demo.aspect;
...
class LogicAspect {
    ...
    @Pointcut("execution(* com.udemyspringappdemo.demo.logic.ProjectService.createGroup(..))")
    ...
    Object aroundGroupCreateGroup(ProceedingJoinPoint jp) {
